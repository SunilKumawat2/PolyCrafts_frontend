...
import { Admin_Update_Password } from "../../../../api/admin/Admin";

const Admin_Password_Change = () => {
    ...
    const handleUpdateProfile = async (e) => {
        ...
        try {
            ...
            const res = await Admin_Update_Password(updatedData);
...
export default Admin_Password_Change;
